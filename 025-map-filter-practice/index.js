...
const cerealData = [ //an array OF objects
  {
    name: "100% Bran",
    mfr: "N",
    type: "C",
...
//find all the cereals that have a rating of over 60!



let goodCereals = cerealData.filter( cereal => cereal.rating > 60 )

console.log(goodCereals)

// const myFilter = (a) => { //a is going to repesent ALL elements in our array
//   return a.mfr === "Q"
// }


// let quakerCereals = cerealData.filter(a => a.mfr === "Q");
...
// const myFunc = cereal => {
//   debugger => SEE what is cereal 
//   return `${cereal.name} only has ${cereal.sugar} sugar.`;
// }

// let cerealNames = cerealData.map( cereal => `${cereal.name}, ${cereal.sugars}` );   //an array of STRING

// console.log(cerealNames);

//function map(func){ iterate through the array and invoke func()   } 